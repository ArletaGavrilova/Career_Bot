...
career_suggestions = {
    ("с людьми", "придумывать новые идеи", "в офисе"): "Маркетолог 🎯",
    ("с компьютерами", "логические задачи", "в офисе"): "Программист 👨‍💻",
    ("с людьми", "логические задачи", "на свежем воздухе"): "Инженер-строитель 🏗️",
    ("с компьютерами", "придумывать новые идеи", "на свежем воздухе"): "Дизайнер интерьеров 🖌️",
    ('с людьми', 'логические задачи', 'в офисе'): 'Бизнес-аналитик 📈'
